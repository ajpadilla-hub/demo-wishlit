...
import com.mydom.demo_wishlist.service.CustomerService;
...
private CustomerService customerService;
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<Customer> create(@RequestBody @Valid Customer newCustomer, @NotNull UriComponentsBuilder uriBuilder) throws EntityAlreadyExistsException {
